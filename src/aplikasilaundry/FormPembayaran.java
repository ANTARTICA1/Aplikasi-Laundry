...
if (rs.next()) {
    ...
    int totalHarga  = rs.getInt("total_harga");   // dari transaksi
    int jumlahBayar = rs.getInt("jumlah_bayar");  // dari pembayaran
    int kembalian   = jumlahBayar - totalHarga;   // HITUNG

    sb.append("╔════════════════════════════╗\n");
    sb.append("║        STRUK LAUNDRY            ║\n");
    sb.append("╚════════════════════════════╝\n\n");

    sb.append("Nama          : " + rs.getString("nama") + "\n");
    sb.append("Berat         : " + rs.getDouble("berat") + " kg\n");
    sb.append("Total Harga   : Rp " + totalHarga + "\n");
    sb.append("Jumlah Bayar  : Rp " + jumlahBayar + "\n");
    sb.append("Kembalian     : Rp " + kembalian + "\n");
    sb.append("Status Cucian : " + rs.getString("status") + "\n");
    sb.append("Status Bayar  : " + rs.getString("status_pembayaran") + "\n");
    sb.append("Tanggal Bayar : " + rs.getString("tanggal_bayar") + "\n");

    sb.append("\n╔════════════════════════════╗\n");
    sb.append("║  Terima kasih sudah datang    ║\n");
    sb.append("╚════════════════════════════╝\n");

    txtStruk.setText(sb.toString());

} else {
    txtStruk.setText("Data pembayaran tidak ditemukan");
}
    ...
    private void initComponents() {
        ...
        btnCetak.setBackground(new java.awt.Color(25, 25, 35));
